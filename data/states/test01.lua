--[[
    ...
    В DS синтаксисе это делается с помощью тегов <state> и <constate>, размещенных в шапке персонажа, либо в фрейме
...
return function ( data, vars ) -- обязательная конструкция, означающая начало стейта
